          ...
          <section v-else>
            ...
            >
                ...
                <v-row dense justify="space-between">
                  <v-col>
                    <section v-if="caseIdAsProp">
                      <router-link :to="getSingleCaseRoute()">
                        This case page
                      </router-link>
                    </section>
                  </v-col>
                  ...
                  <v-col>
                    <v-chip
                      v-if="getSingleCaseById.status == 'Resolved'"
                      class="resolved-chip"
                      :ripple="false"
                      color="transparent"
                    >
              ...
              <vue-markdown
                :linkify="false"
                :source="
                  '**Number of students affected**: <nbsp/> ' +
      ...
      <v-row class="mb-4" dense>
        <v-col md="10" sm="11" xl="8" xs="12">
          <v-sheet elevation="2" rounded>
            <div
              class="common-document-markdown px-2 px-sm-3 px-md-9 pt-1 mb-4 pb-6"
            >
              <h2>Comments</h2>
              <div class="comments">
                <fast-comments-vue
                  :config="{
                    tenantId: '---hidden---',
                    urlId: 'fastcomments:/single-case/' + caseId,
                  }"
                />
              </div>
            </div>
